...
<div class="form-group">
    ...
    <div class="col-sm-7">
    <input type="text" class="form-control" name="session" placeholder="Session(Example:2017-2018)">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-7">
    <input type="text" class="form-control" name="course_code" placeholder="Course ID(Example:CSE 2101)">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-7">
    <input type="text" class="form-control" name="time" placeholder="Time(Example:09:15-10:00)">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-7">
    <input type="text" class="form-control" name="teacher_id" placeholder="Teacher ID(Example:AAA)">
    </div>
</div>

<div class="form-group">
    <label for="session" class="col-sm-2 control-label">Room NO:</label>
    <div class="col-sm-7">
    <input type="text" class="form-control" name="room_no" placeholder="Room ID(Example:414)">
    </div>
</div>
