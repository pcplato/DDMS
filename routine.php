...
//  		$p1=$all['course_code'];
  ...
  //		echo "<td>".$a1['course_code']."</td>";
        echo "<td>".$all['course_code']."</td>";
  //		echo "<td>".$a1['name']."</td>";
  	
//  	$q1=$all['teacher_id'];
        echo "<td>".$all['teacher_id']."</td>";
